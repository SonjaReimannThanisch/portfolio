function showLegalView(startPage) {
    ...
    const privacyPages = createPrivacyPages();
    document.getElementById("legal-view").innerHTML = `
        <section class="legal-slider">
            ...
            <article id="privacy-${index + 1}" class="legal-page privacy-page">
                <div class="legal-content">
                    ${page}
                </div>

                ${index > 0 ? `
                    <a class="legal-prev-link" href="#privacy-${index}">
                ...
                ${index < privacyPages.length - 1 ? `
                    <a class="legal-next-link" href="#privacy-${index + 2}">
                        <img src="./assets/icons/Property 1=Default.png" alt="Next">
                    </a>
                ` : ""}
            </article>
...
function createPrivacyPages() {
    const parts = PRIVACY_POLICY_TEXT.split("<h2");

    let pages = [];
    let currentPage = "";

    parts.forEach((part, index) => {
        const block = index === 0 ? part : "<h2" + part;

        if ((currentPage + block).length > 1800) {
...
const PRIVACY_POLICY_TEXT = `
    ...
    <h3>Kategorien betroffener Personen</h3><ul><li>Kommunikationspartner.</li><li>Nutzer.</li></ul>

    <h3>Zwecke der Verarbeitung</h3><ul><li>Kommunikation.</li><li>Sicherheitsmaßnahmen.</li><li>Organisations- und Verwaltungsverfahren.</li><li>Feedback.</li><li>Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li><li>Informationstechnische Infrastruktur.</li></ul>
